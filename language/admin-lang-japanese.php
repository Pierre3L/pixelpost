...
admin-lang-japanese.php : english (default) language file for Pixelpost-Admin-Section
===================================================================================
Pixelpost version 1.6

SVN file version:
$Id: admin-lang-japanese.php 190 2007-03-28 08:15:27Z schonhose $
...
$admin_lang_pw_wronguser        = "あなたが指定したユーザ名は、Pixelpostの管理ユーザとは異なります。";
$admin_lang_pw_back             =  "管理ページに戻る";
$admin_lang_pw_noemail          = "メールアドレスを入力してください! <br />
                                   パスワード復旧に関して手がかりがない場合、<a href='http://forum.pixelpost.org/'>Pixelpostフォーラム</a>に質問を投稿してください。<br />";
$admin_lang_pw_notsent          = "パスワードは送信されませんでした! <br />あなたが指定したメールアドレスは、Pixelpostの管理パネルのメールアドレスと異なります。<br />";
...
$admin_lang_pw_text_8           = "\n\n自動生成された新しいパスワードでログイン後、パスワードをすぐに変更してください!";
...
$admin_lang_ni_missing_data       = "データがありません。<br />少なくともイメージおよびイメージのタイトルが必要です。
                                     情報が不足しているため、イメージはアップロードされませんでしたので注意してください!";
...
$admin_lang_optn_img_path          = "イメージパス";
...
$admin_lang_optn_title_url_text      = "あなたがインストール時に入力したサイトタイトルおよびURLを確認または修正してください。";
...
$admin_lang_spam_err_5      = "許可するコメント内のリンク数更新中にエラーが発生しました: ";
